...
module.exports = async member => {
    ...
    client.channels.cache.get(config.logs.güvenlik).send({ embeds: [embed.setDescription(`Kullanıcı : ${member}
        
    Hesap Kuruluş Tarihi : \`${kuruluş}\` tarihinde \`${zaman}\` önce oluşturulmuş.`
)] });
